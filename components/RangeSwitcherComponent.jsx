...
const lightWeightChart = () => {
  ...
  return (
    <div>
      ...
      <div className='flex flex-row justify-between items-center w-68 mt-2'>
        {intervals.map((interval, index) => {
          return (
            <div
              className='text-center text-xs rounded-lg px-4 py-2 bg-blue-400 curser-pointer'
              key={index}
              onClick={() => seriesesData(interval.value)}
            >
              <p>{interval.title}</p>
            </div>
          );
